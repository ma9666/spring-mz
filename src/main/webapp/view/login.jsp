...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
    	...
    	<link rel="stylesheet" type="text/css" href="<%=_basePath %>/css/user_login.css">
	</head>
	...
	<body id=userlogin_body>
				...
				<dd id=user_bottom>
					<ul>
						...
						<li class=user_bottom_c>
							<span style="margin-top: 40px"> <a href="#"></a></span>
						</li>
		...
		<script type="text/javascript" src="<%=_basePath %>/js/ux/login.js"></script>
	</body>
</html>
